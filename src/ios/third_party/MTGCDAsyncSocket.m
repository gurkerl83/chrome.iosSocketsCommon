...
NSString *const MTGCDAsyncSocketException = @"GCDAsyncSocketException";
NSString *const MTGCDAsyncSocketErrorDomain = @"GCDAsyncSocketErrorDomain";

NSString *const MTGCDAsyncSocketQueueName = @"GCDAsyncSocket";
NSString *const MTGCDAsyncSocketThreadName = @"GCDAsyncSocket-CFStream";

#if SECURE_TRANSPORT_MAYBE_AVAILABLE
NSString *const MTGCDAsyncSocketSSLCipherSuites = @"GCDAsyncSocketSSLCipherSuites";
#if TARGET_OS_IPHONE
NSString *const MTGCDAsyncSocketSSLProtocolVersionMin = @"GCDAsyncSocketSSLProtocolVersionMin";
NSString *const MTGCDAsyncSocketSSLProtocolVersionMax = @"GCDAsyncSocketSSLProtocolVersionMax";
#else
NSString *const MTGCDAsyncSocketSSLDiffieHellmanParameters = @"GCDAsyncSocketSSLDiffieHellmanParameters";
#endif
#endif
...
- (BOOL)doAccept:(int)parentSocketFD
{
	...
	if (delegateQueue)
	{
		...
		dispatch_async(delegateQueue, ^{ @autoreleasepool {
			...
			MTGCDAsyncSocket *acceptedSocket = [[MTGCDAsyncSocket alloc] initWithDelegate:theDelegate
...
- (void)closeWithError:(NSError *)error
{
	...
	#if SECURE_TRANSPORT_MAYBE_AVAILABLE
	{
		...
		if (sslContext)
		{
            ...
            OSStatus (*SSLClose)(SSLContextRef context) = (OSStatus (*)(SSLContextRef context))dlsym(RTLD_FIRST, "SSLClose");
...
- (NSError *)badConfigError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:MTGCDAsyncSocketErrorDomain code:GCDAsyncSocketBadConfigError userInfo:userInfo];
}
...
- (NSError *)badParamError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:MTGCDAsyncSocketErrorDomain code:GCDAsyncSocketBadParamError userInfo:userInfo];
}
...
- (NSError *)connectTimeoutError
{
	...
	return [NSError errorWithDomain:MTGCDAsyncSocketErrorDomain code:GCDAsyncSocketConnectTimeoutError userInfo:userInfo];
}
...
- (NSError *)readMaxedOutError
{
	...
	return [NSError errorWithDomain:MTGCDAsyncSocketErrorDomain code:GCDAsyncSocketReadMaxedOutError userInfo:info];
}
...
- (NSError *)readTimeoutError
{
	...
	return [NSError errorWithDomain:MTGCDAsyncSocketErrorDomain code:GCDAsyncSocketReadTimeoutError userInfo:userInfo];
}
...
- (NSError *)writeTimeoutError
{
	...
	return [NSError errorWithDomain:MTGCDAsyncSocketErrorDomain code:GCDAsyncSocketWriteTimeoutError userInfo:userInfo];
}
...
- (NSError *)connectionClosedError
{
	...
	return [NSError errorWithDomain:MTGCDAsyncSocketErrorDomain code:GCDAsyncSocketClosedError userInfo:userInfo];
}
...
- (NSError *)otherError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:MTGCDAsyncSocketErrorDomain code:GCDAsyncSocketOtherError userInfo:userInfo];
}
...
- (void)flushSSLBuffers
{
	...
	dispatch_block_t updateEstimatedBytesAvailable = ^{
        ...
        OSStatus (*SSLGetBufferedReadSize)(SSLContextRef context, size_t *bufSize) = (OSStatus (*)(SSLContextRef context, size_t *bufSize))dlsym(RTLD_FIRST, "SSLGetBufferedReadSize");
	...
	if (estimatedBytesAvailable > 0)
	{
		...
		do
		{
            ...
            OSStatus (*SSLRead)(SSLContextRef context, void *data, size_t dataLength, size_t *processed) = (OSStatus (*)(SSLContextRef context, void *data, size_t dataLength, size_t *processed))dlsym(RTLD_FIRST, "SSLRead");
	...
	if (flags & kSocketSecure)
	{
		...
		else
		{
			...
			if (hasCachedDataToWrite)
			{
                ...
                OSStatus (*SSLWrite)(SSLContextRef context, const void * data, size_t dataLength, size_t *processed) = (OSStatus (*)(SSLContextRef context, const void * data, size_t dataLength, size_t *processed))dlsym(RTLD_FIRST, "SSLWrite");
...
- (void)ssl_startTLS
{
	...
	#if TARGET_OS_IPHONE
	{
        SSLContextRef (*SSLCreateContext)(CFAllocatorRef alloc, SSLProtocolSide protocolSide, SSLConnectionType connectionType) = (SSLContextRef (*)(CFAllocatorRef alloc, SSLProtocolSide protocolSide, SSLConnectionType connectionType))dlsym(RTLD_FIRST, "SSLCreateContext");
    ...
    OSStatus (*SSLSetIOFuncs)(SSLContextRef context, SSLReadFunc readFunc, SSLWriteFunc writeFunc) = (OSStatus (*)(SSLContextRef context, SSLReadFunc readFunc, SSLWriteFunc writeFunc))dlsym(RTLD_FIRST, "SSLSetIOFuncs");
    ...
    OSStatus (*SSLSetConnection)(SSLContextRef context, SSLConnectionRef connection) = (OSStatus (*)(SSLContextRef context, SSLConnectionRef connection))dlsym(RTLD_FIRST, "SSLSetConnection");
	...
	if ([value isKindOfClass:[NSString class]])
	{
        ...
        OSStatus (*SSLSetPeerDomainName)(SSLContextRef context, const char *peerName, size_t peerNameLen) = (OSStatus (*)(SSLContextRef context, const char *peerName, size_t peerNameLen))dlsym(RTLD_FIRST, "SSLSetPeerDomainName");
	...
	if (value)
	{
        ...
        OSStatus (*SSLSetCertificate)(SSLContextRef context, CFArrayRef certRefs) = (OSStatus (*)(SSLContextRef context, CFArrayRef certRefs))dlsym(RTLD_FIRST, "SSLSetCertificate");
	...
	#if TARGET_OS_IPHONE
	{
		...
		NSString *sslMinLevel = [tlsSettings objectForKey:MTGCDAsyncSocketSSLProtocolVersionMin];
		NSString *sslMaxLevel = [tlsSettings objectForKey:MTGCDAsyncSocketSSLProtocolVersionMax];
		...
		if (sslMinLevel || sslMaxLevel)
		{
			...
			{
                OSStatus (*SSLSetProtocolVersionMin)(SSLContextRef context, SSLProtocol minVersion) = (OSStatus (*)(SSLContextRef context, SSLProtocol minVersion))dlsym(RTLD_FIRST, "SSLSetProtocolVersionMin");
				status1 = SSLSetProtocolVersionMin(sslContext, minProtocol);
			}
			if (maxProtocol != kSSLProtocolUnknown)
			{
                OSStatus (*SSLSetProtocolVersionMax)(SSLContextRef context, SSLProtocol maxVersion) = (OSStatus (*)(SSLContextRef context, SSLProtocol maxVersion))dlsym(RTLD_FIRST, "SSLSetProtocolVersionMax");
	...
	if (value)
	{
        ...
        OSStatus (*SSLSetEnabledCiphers)(SSLContextRef context, const SSLCipherSuite *ciphers, size_t numCiphers) = (OSStatus (*)(SSLContextRef context, const SSLCipherSuite *ciphers, size_t numCiphers))dlsym(RTLD_FIRST, "SSLSetEnabledCiphers");
...
- (void)ssl_continueSSLHandshake
{
    ...
    OSStatus (*SSLHandshake)(SSLContextRef context) = (OSStatus (*)(SSLContextRef context))dlsym(RTLD_FIRST, "SSLHandshake");
